    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
                <div className="flex flex-col items-center justify-center text-center p-4 bg-gray-50 dark:bg-cyber-black/50 rounded-xl border border-gray-200 dark:border-cyber-gray/50">
                    <h3 className="text-gray-500 dark:text-gray-400 text-[10px] font-mono mb-2 uppercase tracking-widest">{t.chapters}</h3>
                    <span className="text-gray-900 dark:text-white font-bold font-mono text-xl">
                        {result.chapters || '?'}
                    </span>
                </div>
                <div className="flex flex-col items-center justify-center text-center p-4 bg-gray-50 dark:bg-cyber-black/50 rounded-xl border border-gray-200 dark:border-cyber-gray/50">
                    <h3 className="text-gray-500 dark:text-gray-400 text-[10px] font-mono mb-2 uppercase tracking-widest">{t.status}</h3>
                    <span className="text-gray-900 dark:text-white font-bold font-mono text-xl">
                ...
                <div className="flex flex-col items-center justify-center text-center p-4 bg-gray-50 dark:bg-cyber-black/50 rounded-xl border border-gray-200 dark:border-cyber-gray/50">
                    <h3 className="text-gray-500 dark:text-gray-400 text-[10px] font-mono mb-2 uppercase tracking-widest">{t.published}</h3>
                    <span className="text-gray-900 dark:text-white font-bold font-mono text-sm">
                        {result.published || '?'}
                    </span>
                </div>
                <div className="flex flex-col items-center justify-center text-center p-4 bg-gray-50 dark:bg-cyber-black/50 rounded-xl border border-gray-200 dark:border-cyber-gray/50">
                    <h3 className="text-gray-500 dark:text-gray-400 text-[10px] font-mono mb-2 uppercase tracking-widest">{t.score}</h3>
                    <span className="text-gray-900 dark:text-white font-bold font-mono text-xl">
                        {result.score || '?'}
                    </span>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 dark:border-cyber-gray/30">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                        {result.related_manga.map((manga, index) => (
                            <div key={index} className="bg-gray-50 dark:bg-cyber-black/50 rounded-xl p-4 border border-gray-200 dark:border-cyber-gray/50 backdrop-blur-sm flex flex-col items-center justify-center text-center">
                                <h3 className="text-cyber-primary text-[10px] font-mono mb-1 uppercase tracking-widest">
                                ...
                                <a
                                    ...
                                    className="text-gray-900 dark:text-white font-bold font-mono text-sm hover:text-cyber-primary transition-colors w-full break-words"
                                >
                                    {manga.title}
                                </a>
                            </div>
